...
export default function ProduitAdmin() {
  ...
  const handleRowClick = (produit) => {
    setSelectedProduitId(produit.Id); // Mettre à jour l'état avec l'ID du produit
    setShowDetailsModal(true); // Afficher le modal
  };
  ...
  const filteredUpdates = updates.filter((u) => {
    ...
    if (startDate && endDate) {
      const productDate = new Date(u.DateAjout.split('/').reverse().join('-'));
        ...
        <div className="sm:hidden w-full overflow-x-auto">
          <div className="flex items-center gap-2 w-full min-w-0">
            ...
            <DatePicker
              ...
              className="min-w-0 flex-1 p-2 border border-gray-300 rounded-md focus:ring-[#D4AF37] focus:border-blue-500 h-[42px]"
              isClearable
            />
            ...
            <DatePicker
              ...
              dateFormat="dd/MM/yyyy"
              placeholderText="Sélectionner"
              className="min-w-0 flex-1 p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-[#D4AF37]-500 h-[42px]"
              isClearable
            />
          </div>
        </div>
        ...
        <div className="hidden sm:flex items-end gap-4">
          <div className="flex items-center gap-2">
            ...
            <DatePicker
              ...
              dateFormat="dd/MM/yyyy"
              placeholderText="Sélectionner"
              className="w-40 p-2 border border-gray-300 rounded-md focus:ring-[#D4AF37]-500 focus:border-[#D4AF37]-500 h-[42px]"
              isClearable
            />
          </div>
          <div className="flex items-center gap-2">
